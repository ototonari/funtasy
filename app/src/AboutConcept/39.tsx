    ...
    <>
      ...
      <Point>
        <Text>
          {ab([
            ...
            <>
              2次方程式 <MI f="ax^2+bx+c=0" /> は、 <MI f="b^2-4ac \ge 0" />{" "}
              のとき解をもち、
            </>,
            <>
              その解は　　
      ...
      <Paper variant={"outlined"} sx={{ padding: 1, margin: 1 }}>
        ...
        <Text pl={1}>
          {ab([
            <>
              <MI f="b^2-4ac \ge 0" /> に当てはめると <MI f="37 \ge 0" />{" "}
              なので実数の解をもつ。
            </>,
            <>
              なので、{" "}
      ...
      <Point>
        <Text>
          {ab([
            <>
              2次方程式 <MI f="ax^2+bx+c=0" /> は、 <MI f="b'^2-ac \ge 0" />{" "}
              のとき解をもち、
            </>,
            <>
              その解は　　
      ...
      <Paper variant={"outlined"} sx={{ padding: 1, margin: 1 }}>
        ...
        <Text pl={1}>
          {ab([
            <>
              <MI f="b=2b'より、b'=1" /> なので <MI f="b'^2-ac \ge 0" />{" "}
              に当てはめると <MI f="6 \ge 0" /> を満たすので実数の解をもつ。
            </>,
            <>
